...
namespace UPM_IPS.JPBSDSJDFProyectoIPS
{
	...
	/// </summary>
	internal partial class JPBSDSJDFProyectoIPSDocView : JPBSDSJDFProyectoIPSDocViewBase
	{
		/// <summary>
		/// Constructs a new JPBSDSJDFProyectoIPSDocView.
		/// </summary>
		public JPBSDSJDFProyectoIPSDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class JPBSDSJDFProyectoIPSDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new JPBSDSJDFProyectoIPSDocView.
		/// </summary>
		protected JPBSDSJDFProyectoIPSDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			JPBSDSJDFProyectoIPSDocDataBase docData = this.DocData as JPBSDSJDFProyectoIPSDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for JPBSDSJDFProyectoIPSDocViewBase should be an JPBSDSJDFProyectoIPSDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::UPM_IPS.JPBSDSJDFProyectoIPS.IoTModelDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::UPM_IPS.JPBSDSJDFProyectoIPS.IoTModelDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::UPM_IPS.JPBSDSJDFProyectoIPS.JPBSDSJDFProyectoIPSToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::UPM_IPS.JPBSDSJDFProyectoIPS.JPBSDSJDFProyectoIPSToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.JPBSDSJDFProyectoIPSDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::UPM_IPS.JPBSDSJDFProyectoIPS.JPBSDSJDFProyectoIPSHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::UPM_IPS.JPBSDSJDFProyectoIPS.JPBSDSJDFProyectoIPSHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::UPM_IPS.JPBSDSJDFProyectoIPS.JPBSDSJDFProyectoIPSHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
