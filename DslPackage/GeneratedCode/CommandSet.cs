...
namespace UPM_IPS.JPBSDSJDFProyectoIPS
{
	...
	/// </summary>
	internal partial class JPBSDSJDFProyectoIPSCommandSet : JPBSDSJDFProyectoIPSCommandSetBase
	{
		/// <summary>
		/// Constructs a new JPBSDSJDFProyectoIPSCommandSet.
		/// </summary>
		public JPBSDSJDFProyectoIPSCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class JPBSDSJDFProyectoIPSCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new JPBSDSJDFProyectoIPSCommandSetBase.
		/// </summary>
		protected JPBSDSJDFProyectoIPSCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewJPBSDSJDFProyectoIPSExplorerCommand,
				typeof(JPBSDSJDFProyectoIPSEditorFactory).GUID);
		...
		{
			JPBSDSJDFProyectoIPSExplorerToolWindow explorer = this.JPBSDSJDFProyectoIPSExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected JPBSDSJDFProyectoIPSDocData CurrentJPBSDSJDFProyectoIPSDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as JPBSDSJDFProyectoIPSDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected JPBSDSJDFProyectoIPSDocView CurrentJPBSDSJDFProyectoIPSDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as JPBSDSJDFProyectoIPSDocView;
			}
		}
		...
		/// </summary>
		protected JPBSDSJDFProyectoIPSExplorerToolWindow JPBSDSJDFProyectoIPSExplorerToolWindow
		{
			get
			{
				JPBSDSJDFProyectoIPSExplorerToolWindow explorerWindow = null;
				...
				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(JPBSDSJDFProyectoIPSExplorerToolWindow), true) as JPBSDSJDFProyectoIPSExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				JPBSDSJDFProyectoIPSExplorerToolWindow explorerWindow = this.JPBSDSJDFProyectoIPSExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class JPBSDSJDFProyectoIPSClipboardCommandSet : JPBSDSJDFProyectoIPSClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new JPBSDSJDFProyectoIPSClipboardCommandSet.
		/// </summary>
		public JPBSDSJDFProyectoIPSClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class JPBSDSJDFProyectoIPSClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new JPBSDSJDFProyectoIPSClipboardCommandSetBase.
		/// </summary>
		protected JPBSDSJDFProyectoIPSClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
