...
namespace UPM_IPS.JPBSDSJDFProyectoIPS
{
	...
	/// </remarks>
	public partial class JPBSDSJDFProyectoIPSHelpKeywordHelper : JPBSDSJDFProyectoIPSHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new JPBSDSJDFProyectoIPSHelpKeywordHelper.
		/// </summary>
		protected JPBSDSJDFProyectoIPSHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the JPBSDSJDFProyectoIPSHelpKeywordHelper.
		/// </summary>
		public static JPBSDSJDFProyectoIPSHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class JPBSDSJDFProyectoIPSHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new JPBSDSJDFProyectoIPSHelpKeywordHelperBase.
		/// </summary>
		protected JPBSDSJDFProyectoIPSHelpKeywordHelperBase()
			: base() { }
